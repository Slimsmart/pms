    						...
    						<div class="panel-body">
    							<div class="control-group">
    								<div class="controls row-fluid">
    									<input class="span12 form-control aligncenter" type="text" id="" name="staffid" placeholder="Staff Id" autofocus required>
    								</div>
    							</div>
    							<div class="control-group">
    								<div class="controls row-fluid">
    						      <input class="span12 form-control aligncenter" type="text" name="name" placeholder="Name" required>
    								</div>
    							</div>
                  <div class="control-group">
    								<div class="controls row-fluid">
    						      <input class="span12 form-control aligncenter" type="number"  name="phone" placeholder="Phone Number" required>
    								</div>
    							</div>
    						</div>
