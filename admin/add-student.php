  ...
  <div class="container">
  	<div class="row">
        ...
        <div class="panel panel-default">
          <form class="form-vertical" method="post" action="add-student-script.php">
    						...
    						<div class="panel-body">
    							<div class="control-group">
    								<div class="controls row-fluid">
    									<input class="span12 form-control aligncenter" type="text" id="" name="studentid" placeholder="Matriculation Number" autofocus required>
    								</div>
    							</div>
    							<div class="control-group">
    								<div class="controls row-fluid">
    						      <input class="span12 form-control aligncenter" type="text" id="inputPassword" name="name" placeholder="Name" required>
    								</div>
    							</div>
                  <div class="control-group">
    								<div class="controls row-fluid">
    						      <input class="span12 form-control aligncenter" type="text" id="inputPassword" name="phone" placeholder="Phone Number" required>
    								</div>
    							</div>
                  <div class="control-group">
    								<div class="controls row-fluid">
    						      <input class="span12 form-control aligncenter" type="text" id="inputPassword" name="session" placeholder="Accademic Session" required>
    								</div>
    							</div>
    						</div>
    						<div class="panel-footer">
    							<div class="control-group">
    								<div class="controls clearfix">
    									<button type="submit" class="btn btn-primary pull-right" name="addst">Add</button>
    								</div>
    							</div>
    						</div>
    					</form>
