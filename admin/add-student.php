          ...
          <form class="form-vertical" method="post" action="add-student-script.php">
                ...
                <?php endif; unset($_SESSION['errmsg'])?>
    						<div class="card-body p-4">
    							<div class="mb-3">
    								<div class=" row">
    									<input class="col-12 form-control aligncenter" type="text" id="" name="studentid" placeholder="Matriculation Number" autofocus required>
    								</div>
    							</div>
    							<div class="mb-3">
    								<div class=" row">
    						      <input class="col-12 form-control aligncenter" type="text" id="inputPassword" name="name" placeholder="Name" required>
    								</div>
    							</div>
                  <div class="mb-3">
    								<div class=" row">
    						      <input class="col-12 form-control aligncenter" type="text" id="inputPassword" name="phone" placeholder="Phone Number" required>
    								</div>
    							</div>
                  <div class="mb-3">
    								<div class=" row">
    						      <input class="col-12 form-control aligncenter" type="text" id="inputPassword" name="session" placeholder="Accademic Session" required>
    								</div>
    							</div>
    						</div>
