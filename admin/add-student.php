...
<?php if (isset($_SESSION['pass'])): ?>
  ...
  <head>
  <meta charset="utf-8">
  <title>Register Student - Admin Portal</title>
  ...
  <div class="container">
  	<div class="row justify-content-center">
  		<div class="col-md-6">
        <div class="card p-4">
          <form method="post" action="add-student-script.php">
    						<div class="border-bottom-0 pb-3">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        <h3 class="mb-0 fw-bold text-slate-800">Register Student</h3>
                                        <p class="text-muted mb-0 small">Create a new student account</p>
                                    </div>
                                </div>
    						</div>
    						...
    						<div class="card-body px-0 py-3">
    							<div class="form-floating mb-4">
    								<input class="form-control" type="text" id="studentid" name="studentid" placeholder="Matriculation Number" autofocus required>
                                    <label for="studentid"><i class="fa-solid fa-id-card me-2 text-muted"></i>Matriculation Number (Login Username)</label>
    							</div>
    							<div class="form-floating mb-4">
                                ...
                                <div class="form-floating mb-4">
    						        <input class="form-control" type="text" id="session" name="session" placeholder="Academic Session" required>
                                    <label for="session"><i class="fa-solid fa-calendar-days me-2 text-muted"></i>Academic Session (e.g. 2025/2026)</label>
    							</div>
    						</div>
    						<div class="border-top-0 pt-2 d-flex justify-content-end">
    							<button type="submit" class="btn-submit" name="addst">
                                    Register Student <i class="fa-solid fa-plus ms-2"></i>
                                </button>
    						</div>
    					</form>
        </div>
