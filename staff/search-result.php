	        ...
	        <div class="row-fluid">
	          <div class="span7">
	            <div class="form-group">
	    					<input type="text" name="q" class="form-control alignleft" value="<?php echo $qw; ?>" placeholder="Enter project topic/ research area" style="height:100%; padding:12px; border-radius:0px; width:justify">
	    				</div>
	          </div>
	            <div class="span5">
	              <div class="form-group">
